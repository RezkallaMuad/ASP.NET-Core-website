    ...
    <div style={{ padding: "60px 40px", maxWidth: 800, margin: "0 auto" }}>
      ...
      <article>
        <header style={{ marginBottom: 30 }}>
          ...
          <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 40, color: PALETTE.text, lineHeight: 1.2, marginBottom: 16 }}>
            {post.title}
          </h1>
          <p style={{ fontSize: 18, color: PALETTE.muted, lineHeight: 1.5, fontStyle: "italic" }}>
            {post.summary}
          </p>
        </header>

        {post.imageUrl && (
          <div style={{ width: "100%", maxHeight: 450, borderRadius: 12, overflow: "hidden", marginBottom: 36, border: `1px solid ${PALETTE.border}` }}>
